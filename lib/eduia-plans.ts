...
export const EDUIA_PLANS: EduIAPlan[] = [
  {
    id: "university",
    name: "University",
    tagline: "IA Adaptativa v3 — Diagnóstico, Plan y Predicción de Resultado",
    audience: "Para estudiantes que quieren el tutor más estratégico, exigente y personalizado.",
    priceLabel: "$4.50/mes",
    monthlyPrice: 4.5,
    ...
    ctaKind: "select",
    features: [
      { label: "Diagnóstico cognitivo completo: identifica tus lagunas exactas y su causa raíz", emphasized: true },
      { label: "Análisis metacognitivo del error: por qué fallas y cómo corregirlo definitivamente" },
      { label: "Plan de estudio adaptativo semana a semana según tu tiempo y objetivos" },
      { label: "Modo socrático: preguntas guía para que razones, no memorices" },
      { label: "Predicción de resultado real y estimación de preparación honesta" },
      { label: "Nota de sesión y seguimiento de progreso en cada conversación" },
    ],
  },
  {
    id: "master",
